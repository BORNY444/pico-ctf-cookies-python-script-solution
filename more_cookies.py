...
cookie = "citkRWxXSVVkaForamVZWFVjeHZwdG00ZG5ockJJU3J1NEp5aXh6VEptOUxqKzY3dVJmcXJ0VkZmN0ZJVm16Mk1nNS9aMnBOSUhBaDZveEFUcGQ0T3diRGllNVVDeWEyOFk1cjJCS0g4R0RySWdzdGswYnhhNkN1M1NIeWJSb3c="
...
for position_idx in tqdm(range(10), desc="Bruteforcing Position"):
    ...
    for bit_idx in tqdm(range(96), desc="Bruteforcing Bit"):
        ...
        r = requests.get('http://mercury.picoctf.net:53700/', cookies=cookies)
